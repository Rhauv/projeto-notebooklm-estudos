...
* **Intrínseca:** A complexidade real do assunto.
* **Extrínseca (Ruído):** Distrações e má organização que consomem energia inutilmente.
* **Germane (Essencial):** O esforço focado em criar esquemas mentais de longo prazo.

### Empilhamento de Hábitos (Habit Stacking)
Técnica que consiste em usar um hábito automático como "âncora" para um novo, economizando força de vontade.
* **Exemplo prático:** Estudar por 25 minutos logo após preparar o café da manhã, tornando a transição para o estudo automática e prazerosa.
...
| :--- | :--- | :--- |
| Se distrai fácil | **Pomodoro** | Gerencia o foco e reduz a carga extrínseca. |
...
### Fontes Utilizadas:
* **Artigos:** Carga Cognitiva (Murilo F. de Souza); Active Recall (Birmingham City University); Habit Stacking (James Clear); Métodos de Estudo (FastFormat e Brasil Escola).
* **Vídeos:** Prof. Gustavo Reis (Carga Cognitiva); Socratica (Feynman); RTM Brasil (Dopamina).

---
*Relatório gerado com auxílio do NotebookLM para o curso de IA Generativa da DIO.*
